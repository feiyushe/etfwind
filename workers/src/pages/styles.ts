...
.cycle-card { background: #fff; border-radius: 10px; padding: 12px 16px; margin-bottom: 10px; box-shadow: 0 1px 4px rgba(0,0,0,0.06); }
.cycle-bar { display: flex; align-items: center; gap: 4px; flex-wrap: wrap; justify-content: center; }
.cycle-stage { font-size: 13px; padding: 4px 10px; background: #f3f4f6; border-radius: 6px; white-space: nowrap; }
...
.cycle-arrow { color: #d1d5db; font-size: 12px; }
.cycle-hint { text-align: center; margin-top: 8px; font-size: 12px; color: #6b7280; }
